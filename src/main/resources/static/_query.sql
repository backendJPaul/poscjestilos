...
insert into category(name)values("Conjunto_deportivo");
...
insert into category(name)values("Ropa_formal");
...
insert into material(name)values("Licra");
insert into material(name)values("Algodon");
insert into material(name)values("Algodon_pima");
insert into material(name)values("Dakota");
insert into material(name)values("FrenchTerry");
insert into material(name)values("FrenchTerry_perchado");
insert into material(name)values("Polyester");
insert into material(name)values("Spandex");
insert into material(name)values("Franela");
insert into material(name)values("Suplex");
insert into material(name)values("Tela_mojada");
...
insert into color(name)values("guinda");
